...
def main():
    ...
    source, request, RequestID = determine_source(year, month, day, ModelRun)
    ...
    if parameter == '-v':
        ...
        write_tmp(year, month, day, source, request, ModelRun, RequestID,
...
def determine_source(year, month, day, ModelRun):
    ...
    Request_page = 'https://www.ncdc.noaa.gov/has/HAS.FileAppRouter?' +\
                   'datasetname=GFS&subqueryby=STATION&applname=&outdest=FILE'
    NCEI_source  = 'https://nomads.ncdc.noaa.gov/data/gens/'
    NCEP_source  = 'https://www.ftp.ncep.noaa.gov/data/nccf/com/gens/prod/'
...
### write_tmp Function #####
############################
def write_tmp(year, month, day, source, request, ModelRun, RequestID, 
